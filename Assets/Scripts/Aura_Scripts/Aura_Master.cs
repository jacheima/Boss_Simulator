...
public class Aura_Master : MonoBehaviour
{
    ...
    /// </summary>
    public delegate void AuraSystem(Globals.EMOTION emotion, float transferenceValue);
    ...
    public void EventModifyEmotion(Globals.EMOTION emotion, float transferenceValue)
    {
